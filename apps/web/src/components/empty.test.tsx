...
describe("empty components", () => {
  it("renders slots and merges custom classes", () => {
    ...
    expect(
      screen.getByText("No data").closest('[data-slot="empty-title"]'),
    ...
    expect(
      screen.getByText("Actions").closest('[data-slot="empty-content"]'),
    ).toHaveClass("custom-content");
    expect(
      screen.getByText("No data").closest('[data-slot="empty-header"]'),
    ).toHaveClass("custom-header");
    expect(
      screen.getByText("Actions").closest('[data-slot="empty"]'),
  ...
  it("uses default media variant when none is provided", () => {
    ...
    expect(
      screen.getByText("plain").closest('[data-slot="empty-icon"]'),
