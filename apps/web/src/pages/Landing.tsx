  ...
  return (
    <div className="landing-body">
      ...
      <header className="landing-header">
        <div className="container">
          ...
          <nav className="nav-sections">
            <a href="#how-it-works" className="nav-section-link">
              Как это работает
            </a>
            <button
              type="button"
            ...
            <a href="#audience" className="nav-section-link">
              О нас
            </a>
            <a href="#cta" className="nav-section-link">
              Контакты
            </a>
          </nav>
          <nav className="nav">
            ...
            <Link to="/beta-test" className="nav-btn">
              Бета-тестирование
            </Link>
          </nav>
          <button
            className={`burger ${isMenuOpen ? "burger--close" : ""}`}
            onClick={toggleMenu}
          >
          ...
          <div
            className={`landing-header-mobile ${isMenuOpen ? "active" : ""}`}
          >
            <nav className="nav-sections">
              <a href="#how-it-works" className="nav-section-link">
                Как это работает
        ...
        <div className="container">
          <div className="hero-content">
            ...
            <p className="hero-subtitle">
              Delёz — персональный ИИ-ассистент, который помогает осмыслить
              события, эмоции и решения через призму философии Жиля Делёза.
            </p>
      ...
      <section className="problem">
        <div className="container">
          ...
          <p className="problem-text">
            Обычные дневники и чат-боты забывают твой контекст. Ты снова и снова
            наступаешь на те же грабли, потому что:
          </p>
          <div className="problem-list">
            <div className="problem-item">
              <img
                src={memoryIcon}
                alt="Выводы забываются"
            ...
            <div className="problem-item">
              <img
                src={historyIcon}
                alt="Уроки прошлого не работают в настоящем"
                className="problem-icon"
              />
      ...
      <section id="how-it-works" className="how-it-works">
        <div className="container">
          <h2 className="section-title">
            Delёz запоминает, анализирует и связывает
          </h2>
      ...
      <section className="visual-system">
        <div className="container">
          <h2 className="section-title">
            Все события фиксируются ассистентом и связываются с остальными
          </h2>
          <p className="section-subtitle">
            Все наши события, решения, эмоции и желания — это переплетённая сеть
            влияний, порождающая новые смыслы и возможности.
          </p>
          <div className="rhizome-description">
            <p>
              Delёz строит ризому - граф, связывающий произошедшее воедино. Он
              находит связи между событиями и визуализирует их положительным или
              негативным окрасом.
            </p>
          </div>
          <div className="demo-section">
            <img
              src={macbookImage}
              alt="Пример ризомы в Delёz"
              className="macbook-demo"
            />
            <p className="demo-caption">
              Пример ризомы: связи между событиями, эмоциями и выводами
            </p>
          </div>
        </div>
      </section>
      ...
      <section className="ai-assistant">
        <div className="container">
          <h2 className="section-title">
            Это не просто дневник. Это пожизненный ИИ-ассистент
          </h2>
          ...
          <div className="assistant-grid">
            <div className="assistant-card">
              ...
              <p className="assistant-description">
                Показывает то, как ты изменился и что на тебя повлияло
              </p>
            </div>
            <div className="assistant-card">
              <h4>Задает правильные вопросы</h4>
              <p className="assistant-description">
                Он не навязывает своё решение, а помогает тебе самому его найти
              </p>
            </div>
            <div className="assistant-card">
              <h4>Превращает хаос в мудрость</h4>
              <p className="assistant-description">
                Из разрозненных событий создает связную историю твоей жизни
              </p>
            </div>
            <div className="assistant-card">
              <h4>Защищает приватность</h4>
              <p className="assistant-description">
                Благодаря end-to-end шифрованию и zero-knowledge архитектуре
              </p>
            </div>
          </div>
        </div>
          ...
          <div className="experiment-example">
            ...
            <div className="experiment-details">
              <div className="experiment-item">
                <strong>Гипотеза:</strong> После разрыва эмоциональная
                интенсивность вырастет
              </div>
              <div className="experiment-item">
                <strong>Реальность:</strong> Первая неделя — падение до -8,
                затем постепенное восстановление
              </div>
              <div className="experiment-item">
                <strong>Выводы:</strong> Важно проживать фазу утраты, даже если
                отношения были токсичными
              </div>
            </div>
          </div>
      ...
      <section className="analysis">
        <div className="container">
          ...
          <p className="analysis-tech">
            Инструмент: Встроенный анализ через GraphAG и поиск по эмбеддингам
            (EmbeddingsGigaR)
          </p>
        </div>
      </section>
        ...
        <div className="container">
          ...
          <div className="security-features">
            ...
            <div className="security-item">
              <img
                src={shieldIcon}
                alt="Zero-knowledge архитектура"
                className="security-icon"
              />
      ...
      <section className="philosophy">
        <div className="container">
          ...
          <p className="philosophy-text">
            Delёz помогает не просто записывать события, а видеть связи,
            интенсивность и процесс становления себя.
          </p>
        </div>
      </section>
      ...
      <section id="cta" className="cta">
        <div className="container">
          <div className="cta-content">
            ...
            <p>
              Записывай события, цели, эмоции. Анализируй, как ты меняешься.
              Экспериментируй с собой. Превращай хаос в мудрость.
            </p>
