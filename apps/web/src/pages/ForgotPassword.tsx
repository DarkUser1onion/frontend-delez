...
export default function ForgotPassword() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      logger.debug("Sending password reset request", {
      ...
      for (const endpoint of possibleEndpoints) {
        try {
          ...
          logger.debug(
            `Endpoint ${endpoint} response status: ${response.status}`,
          );
      ...
      if (data.success === false) {
        setError(
          "Не удалось отправить письмо. Проверьте email-адрес или попробуйте позже",
        );
        return;
      }
    ...
    <div className="auth-body auth-page">
      ...
      <div className="auth-container">
        <div className="form-box">
          ...
          <p className="auth-subtitle">
            Введите email-адрес, указанный при регистрации, и мы отправим ссылку
            для сброса пароля
          </p>
