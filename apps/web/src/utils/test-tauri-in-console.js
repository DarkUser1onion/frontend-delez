...
console.log(
  ...
  window.__TAURI_INTERNALS__ ? "✓ Найден" : "✗ Не найден",
);
console.log(
  "   window.__TAURI__:",
  window.__TAURI__ ? "✓ Найден" : "✗ Не найден",
);
console.log(
  "   window.__TAURI_IPC__:",
  window.__TAURI_IPC__ ? "✓ Найден" : "✗ Не найден",
);
...
console.log(
  '   - testTauriEmit("event-name", {data: "test"}) - отправить событие',
);
